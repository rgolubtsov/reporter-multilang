--
-- data/sql/sl-03-create-and-populate-table-data_items.sql
-- ============================================================================
...
create table data_items (id          integer   primary key   autoincrement,
                         name        character varying(64)   not null,
                         description character varying(1024) not null,
                         attr_x0_id  integer                 not null
                             references attr_x0s(id)      on delete restrict,
                         attr_x1_id  integer                 not null
